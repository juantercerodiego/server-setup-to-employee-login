...
**Quick Note:** This project builds on top of my cloud network setup. If you want to see how I configured the virtual machines and networks first, check out that guide here: [https://github.com/juantercerodiego/azure-vm-network-setup].
</p>
